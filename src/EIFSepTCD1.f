...
!--------- adap
       !print *, iid,'-1call',i, dlgnD1o(i)
       call adap(dlgnD1o(i),tauD1,dtt)
       !print *, iid,'-1call',i, dlgnD1o(i)
       call adap(dlgnFo(i),tauF,dtt)
       dlFD = dlgnFo(i)*dlgnD1o(i)
       !print *, iid,'-',i, 'decay end',sngl(dlgnFo(i)),
     !1  sngl(dlgnD1o(i)),sngl(dlFD),sngl(dtsp)
       dlgnD1o(i) = dlgnD1o(i) * dlD
       dlgnFo(i) = dlgnFo(i) + dlF
       !print *, iid,'-',i, 'decay start',
     !1  sngl(dlgnFo(i)),sngl(dlgnD1o(i))
!--------- ampa exc
