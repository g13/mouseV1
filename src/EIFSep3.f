...
!------------------------------------------------------------
      write(thetafdr, '(I2.2)') (2*ntheta+intheta-1)
...
!!------------------------------------------------------------
      ...
      print *,' ' 
        enddo
      if (neps.eq.4) then
        open(11111,file='analInput_hahaha',status='replace',
     1    form='formatted',access='sequential')
        do i=1,nmax
          write(11111,'(I3)') nlgni(i)
        enddo
        write(11111,'(I3)') ntheta*3
        write(11111,'(I3)') neps
        write(11111,'(I4)') nr
        write(11111,'(I4)') lgnmax 
        write(11111,'(I4)') lgnmin
        write(11111,'(I3)') iperiod
        do ineps = 1,neps
            eps = 0.125D0*(2**(ineps-1))
            write(11111,'(I4.4)') int(eps*1000) 
        enddo
        close(11111)
      endif
!!============================================================
